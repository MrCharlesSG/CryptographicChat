...
class ClientAuthService:
    @staticmethod
    def send_login(username):  #encrypted with spbk
        """
    ...
    @staticmethod
    def receive_login(returned_from_server, password):  #encrypted with spbk
        """
        receive
    ...
    @staticmethod
    def receive_register(returned_from_server, password):  #encrypted with spbk
        """
        receive encrypted username and password with spbk and
            1. check signature
