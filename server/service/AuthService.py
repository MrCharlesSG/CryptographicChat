...
from server.config.dummy_db import server_public_key, server_private_key
from server.dal.ChatRepository import ChatRepository
from server.dal.UserRepository import UserRepository
from utils.StringUtils import credentials_from_str
...
class ServerAuthService:
    ...
    def login(encrypted_username):
        ...
        signature = RSACipher.sign(user.private_key_to_store, server_private_key)

        to_return = {
            "prk": user.private_key_to_store,
